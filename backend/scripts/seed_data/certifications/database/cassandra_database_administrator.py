...
QUESTIONS = [
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Cassandra chooses Availability and Partition tolerance over Consistency", "is_correct": True},
            {"text": "Cassandra chooses Consistency and Availability over Partition tolerance", "is_correct": False},
            {"text": "Cassandra provides all three: Consistency, Availability, and Partition tolerance", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "A key that determines which node stores a row", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "All replicas will eventually have the same data", "is_correct": True},
            {"text": "Data is immediately consistent across all nodes", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "A container for tables that defines replication strategy", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Merging SSTables to improve performance and reclaim space", "is_correct": True},
