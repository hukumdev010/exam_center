...
QUESTIONS = [{"text": "What type of database is Redis?",
              ...
              "points": 1,
              "answers": [{"text": "In-memory data structure store",
                           "is_correct": True},
             ...
             {"text": "What is Redis persistence?",
              ...
              "points": 1,
              "answers": [{"text": "Writing data to disk to survive restarts",
                           "is_correct": True},
                          {"text": "Keeping data only in memory",
                           "is_correct": False},
                          {"text": "Replicating data to other servers",
                           "is_correct": False},
                          {"text": "Compressing data structures",
                           "is_correct": False},
                          ],
              },
             {"text": "What is Redis Cluster?",
              ...
              "points": 1,
              "answers": [{"text": "Automatic sharding across multiple Redis nodes",
                           "is_correct": True,
                           },
                          {"text": "A single Redis instance with multiple databases",
                           "is_correct": False,
                           },
                          {"text": "A backup and recovery solution",
                           "is_correct": False},
                          {"text": "A monitoring tool for Redis",
                           "is_correct": False},
                          ],
              },
