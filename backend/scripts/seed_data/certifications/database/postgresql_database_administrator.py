...
QUESTIONS = [{"text": "What is MVCC in PostgreSQL?",
              ...
              "points": 1,
              "answers": [{"text": "Multi-Version Concurrency Control for transaction isolation",
                           "is_correct": True,
                           },
                          {"text": "Multiple Virtual Connection Controller",
                           "is_correct": False},
                          {"text": "Master-Validator Configuration Control",
                           "is_correct": False},
                          {"text": "Memory Variable Cache Control",
                           "is_correct": False},
                          ],
              },
             ...
             {"text": "What is a PostgreSQL tablespace?",
              ...
              "points": 1,
              "answers": [{"text": "A location in the file system for storing database files",
                           "is_correct": True,
                           },
                          {"text": "A temporary storage area for queries",
                           "is_correct": False},
                          {"text": "A memory allocation for connections",
                           "is_correct": False},
             ...
             {"text": "Which PostgreSQL feature provides automatic query optimization?",
              ...
              "points": 1,
              "answers": [{"text": "Query planner/optimizer",
                           "is_correct": True},
                          {"text": "Auto-vacuum",
                           "is_correct": False},
             ...
             {"text": "What is the purpose of VACUUM in PostgreSQL?",
              ...
              "points": 1,
              "answers": [{"text": "Reclaim storage and update statistics",
                           "is_correct": True},
                          {"text": "Create database backups",
                           "is_correct": False},
                          {"text": "Compress database files",
                           "is_correct": False},
