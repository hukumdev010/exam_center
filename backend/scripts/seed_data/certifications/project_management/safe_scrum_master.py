...
QUESTIONS = [{"text": "What is the primary role of a Scrum Master in SAFe?",
              ...
              "points": 1,
              "answers": [{"text": "Managing the team's backlog",
                           "is_correct": False},
                          {"text": "Facilitating team events and removing impediments",
                           "is_correct": True,
                           },
                          {"text": "Making technical decisions",
                           "is_correct": False},
                          {"text": "Assigning tasks to team members",
                           "is_correct": False},
                          ],
              },
             {"text": "What is an Agile Release Train (ART) in SAFe?",
              ...
              "points": 1,
              "answers": [{"text": "A single Scrum team",
                           "is_correct": False},
             ...
             {"text": "What happens during PI Planning in SAFe?",
              ...
              "points": 1,
              "answers": [{"text": "Individual team sprint planning",
                           "is_correct": False},
             ...
             {"text": "What is the Scrum Master's role during the Inspect and Adapt (I&A) event?",
              ...
              "points": 1,
              "answers": [{"text": "Present demo to stakeholders",
                           "is_correct": False},
                          {"text": "Facilitate retrospective and support team improvement",
                           "is_correct": True,
                           },
                          {"text": "Plan next PI objectives",
                           "is_correct": False},
                          {"text": "Conduct performance evaluations",
                           "is_correct": False},
                          ],
              },
             ]
