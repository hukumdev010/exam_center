...
QUESTIONS = [{"text": "What is the primary focus of the Agile Manifesto?",
              ...
              "points": 1,
              "answers": [{"text": "Comprehensive documentation",
                           "is_correct": False},
             ...
             {"text": "In Scrum, what is the maximum recommended duration for a Sprint?",
              ...
              "points": 1,
              "answers": [{"text": "2 weeks",
                           "is_correct": False},
                          {"text": "4 weeks (1 month)",
                           "is_correct": True},
                          {"text": "6 weeks",
                           "is_correct": False},
                          {"text": "8 weeks",
             ...
             {"text": "What is the purpose of a retrospective in agile methodologies?",
              ...
              "points": 1,
              "answers": [{"text": "To plan the next iteration",
                           "is_correct": False},
                          {"text": "To identify improvements for future iterations",
                           "is_correct": True,
                           },
                          {"text": "To review completed features",
                           "is_correct": False},
                          {"text": "To estimate user stories",
                           "is_correct": False},
                          ],
              },
             {"text": "Which principle is fundamental to Kanban?",
              ...
              "points": 1,
              "answers": [{"text": "Fixed iterations",
                           "is_correct": False},
                          {"text": "Visualizing work and limiting WIP",
                           "is_correct": True},
                          {"text": "Daily standups",
                           "is_correct": False},
             ...
             {"text": "What does 'velocity' measure in agile project management?",
              ...
              "points": 1,
              "answers": [{"text": "Team satisfaction",
                           "is_correct": False},
                          {"text": "Amount of work completed per Sprint",
                           "is_correct": True},
                          {"text": "Code quality",
                           "is_correct": False},
