...
QUESTIONS = [{"text": "Which SAS procedure is used for descriptive statistics?",
             ...
             {"text": "What is the purpose of PROC FREQ in SAS?",
              ...
              "points": 1,
              "answers": [{"text": "Generate frequency tables and cross-tabulations",
                           "is_correct": True,
                           },
                          {"text": "Calculate correlation coefficients",
                           "is_correct": False},
             ...
             {"text": "Which statement is used to create a new variable in a SAS DATA step?",
              ...
              "points": 1,
              "answers": [{"text": "Assignment statement (variable = expression)",
                           "is_correct": True,
                           },
                          {"text": "PROC statement",
                           "is_correct": False},
             ...
             {"text": "What does the BY statement do in SAS procedures?",
              ...
              "points": 1,
              "answers": [{"text": "Process data separately for each unique value of specified variables",
                           "is_correct": True,
                           },
                          {"text": "Sort the dataset",
                           "is_correct": False},
