...
QUESTIONS = [{"text": "What is the fundamental data structure in Apache Spark?",
              ...
              "points": 1,
              "answers": [{"text": "RDD (Resilient Distributed Dataset)",
                           "is_correct": True},
                          {"text": "DataFrame",
                           "is_correct": False},
                          {"text": "Dataset",
             ...
             {"text": "What is the difference between transformations and actions in Spark?",
              ...
              "points": 1,
              "answers": [{"text": "Transformations are lazy; actions trigger computation",
                           "is_correct": True,
                           },
                          {"text": "Transformations are faster than actions",
                           "is_correct": False},
             ...
             {"text": "What is a Spark DataFrame?",
              ...
              "points": 1,
              "answers": [{"text": "A distributed collection of data organized into named columns",
                           "is_correct": True,
                           },
                          {"text": "A single machine data structure",
                           "is_correct": False},
