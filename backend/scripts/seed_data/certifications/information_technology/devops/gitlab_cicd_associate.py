...
QUESTIONS = [{"text": "What is GitLab CI/CD?",
              ...
              "points": 1,
              "answers": [{"text": "A built-in tool for automated build, test, and deployment",
                           "is_correct": True,
                           },
             ...
             {"text": "What is a GitLab Runner?",
              ...
              "points": 1,
              "answers": [{"text": "An application that executes CI/CD jobs",
                           "is_correct": True},
                          {"text": "A user with special permissions",
                           "is_correct": False},
                          {"text": "A backup system",
                           "is_correct": False},
             ...
             {"text": "What are GitLab CI/CD stages?",
              ...
              "points": 1,
              "answers": [{"text": "Groups of jobs that define execution order in pipelines",
                           "is_correct": True,
                           },
                          {"text": "Different environments for deployment",
                           "is_correct": False},
                          {"text": "User permission levels",
                           "is_correct": False},
                          {"text": "Git branch types",
                           "is_correct": False},
                          ],
              },
             {"text": "What is the purpose of GitLab CI/CD variables?",
              ...
              "points": 1,
              "answers": [{"text": "Pass configuration and sensitive data to jobs securely",
                           "is_correct": True,
                           },
                          {"text": "Store git commit messages",
                           "is_correct": False},
                          {"text": "Define user permissions",
                           "is_correct": False},
                          {"text": "Configure GitLab server settings",
                           "is_correct": False},
                          ],
              },
             ]
