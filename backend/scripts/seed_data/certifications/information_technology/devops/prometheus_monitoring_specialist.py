...
QUESTIONS = [{"text": "What is Prometheus?",
              ...
              "points": 1,
              "answers": [{"text": "An open-source monitoring and alerting toolkit",
                           "is_correct": True,
                           },
             ...
             {"text": "What is PromQL?",
              ...
              "points": 1,
              "answers": [{"text": "Prometheus Query Language for selecting and aggregating metrics",
                           "is_correct": True,
                           },
                          {"text": "A programming language for writing monitoring scripts",
                           "is_correct": False,
                           },
                          {"text": "A configuration file format",
                           "is_correct": False},
                          {"text": "A database schema language",
                           "is_correct": False},
                          ],
              },
             {"text": "What is a Prometheus scrape target?",
              ...
              "points": 1,
              "answers": [{"text": "An endpoint that Prometheus pulls metrics from",
                           "is_correct": True,
                           },
                          {"text": "A backup storage location",
                           "is_correct": False},
                          {"text": "A user interface component",
                           "is_correct": False},
                          {"text": "A log file destination",
                           "is_correct": False},
                          ],
              },
             {"text": "What is Grafana's relationship to Prometheus?",
              ...
              "points": 1,
              "answers": [{"text": "Grafana visualizes data from Prometheus through dashboards",
                           "is_correct": True,
                           },
                          {"text": "Grafana replaces Prometheus",
                           "is_correct": False},
                          {"text": "Grafana is part of Prometheus",
                           "is_correct": False},
                          {"text": "They are competing products",
                           "is_correct": False},
                          ],
              },
             {"text": "What is Alertmanager in the Prometheus ecosystem?",
              ...
              "points": 1,
              "answers": [{"text": "Handles alert deduplication, grouping, and routing",
                           "is_correct": True,
                           },
                          {"text": "Generates metrics data",
                           "is_correct": False},
                          {"text": "Creates visualization dashboards",
                           "is_correct": False},
                          {"text": "Stores long-term metrics",
                           "is_correct": False},
                          ],
              },
             ]
