...
QUESTIONS = [{"text": "What is Infrastructure as Code (IaC)?",
              ...
              "points": 1,
              "answers": [{"text": "Managing infrastructure through machine-readable definition files",
                           "is_correct": True,
                           },
                          {"text": "Writing application code for infrastructure",
                           "is_correct": False,
                           },
                          {"text": "Manually configuring servers",
                           "is_correct": False},
                          {"text": "Using only graphical interfaces",
                           "is_correct": False},
                          ],
              },
             {"text": "What is the Terraform state file?",
              ...
              "points": 1,
              "answers": [{"text": "A file that tracks managed resources and their current state",
                           "is_correct": True,
                           },
                          {"text": "A configuration file for Terraform settings",
                           "is_correct": False,
                           },
                          {"text": "A backup of infrastructure code",
                           "is_correct": False},
                          {"text": "A log file of Terraform operations",
                           "is_correct": False},
                          ],
              },
             {"text": "What does 'terraform plan' do?",
              ...
              "points": 1,
              "answers": [{"text": "Creates an execution plan showing proposed changes",
                           "is_correct": True,
                           },
                          {"text": "Applies changes to infrastructure",
                           "is_correct": False},
                          {"text": "Destroys all resources",
                           "is_correct": False},
                          {"text": "Validates syntax only",
                           "is_correct": False},
                          ],
              },
             {"text": "What is a Terraform provider?",
              ...
              "points": 1,
              "answers": [{"text": "A plugin that manages resources for specific services",
                           "is_correct": True,
                           },
                          {"text": "A user who provides Terraform code",
                           "is_correct": False},
                          {"text": "A hosting service for Terraform",
                           "is_correct": False},
             ...
             {"text": "What is the purpose of Terraform modules?",
              ...
              "points": 1,
              "answers": [{"text": "Reusable packages of configuration for code organization",
                           "is_correct": True,
                           },
                          {"text": "Individual resource definitions",
                           "is_correct": False},
                          {"text": "Terraform installation packages",
                           "is_correct": False},
