...
QUESTIONS = [{"text": "What is Azure DevOps?",
              ...
              "points": 1,
              "answers": [{"text": "A set of development tools and services for the software development lifecycle",
                           "is_correct": True,
                           },
                          ...
                          {"text": "A database management system",
                           "is_correct": False},
                          {"text": "A container orchestration service",
                           "is_correct": False},
                          ],
              },
             {"text": "What is Azure Pipelines?",
              ...
              "points": 1,
              "answers": [{"text": "A cloud service for automated build, test, and deployment",
                           "is_correct": True,
                           },
             ...
             {"text": "What is the difference between Build and Release pipelines in Azure DevOps?",
              ...
              "points": 1,
              "answers": [{"text": "Build pipelines create artifacts; Release pipelines deploy them",
                           "is_correct": True,
                           },
                          {"text": "Build pipelines are faster than Release pipelines",
                           "is_correct": False,
                           },
                          {"text": "Release pipelines are deprecated",
                           "is_correct": False},
             ...
             {"text": "What is Azure Repos?",
              ...
              "points": 1,
              "answers": [{"text": "Git repositories and version control for source code",
                           "is_correct": True,
                           },
                          {"text": "A container registry",
                           "is_correct": False},
                          {"text": "A package management system",
                           "is_correct": False},
             ...
             {"text": "What is Azure Boards?",
              ...
              "points": 1,
              "answers": [{"text": "Agile tools for planning and tracking work using Kanban and Scrum",
                           "is_correct": True,
                           },
                          {"text": "A deployment dashboard",
                           "is_correct": False},
                          {"text": "A code analysis tool",
                           "is_correct": False},
