...
QUESTIONS = [{"text": "What is the CAP theorem and how does Cassandra handle it?",
              ...
              "points": 1,
              "answers": [{"text": "Cassandra chooses Availability and Partition tolerance over Consistency",
                           "is_correct": True,
                           },
                          ...
                          {"text": "Cassandra only provides Consistency",
                           "is_correct": False},
                          ],
              },
             {"text": "What is a partition key in Cassandra?",
              ...
              "points": 1,
              "answers": [{"text": "A key that determines which node stores a row",
                           "is_correct": True,
                           },
                          {"text": "A key that encrypts data",
                           "is_correct": False},
                          {"text": "A key that sorts data within a partition",
                           "is_correct": False},
                          {"text": "A key that creates database backups",
                           "is_correct": False},
                          ],
              },
             {"text": "What is eventual consistency in Cassandra?",
              ...
              "points": 1,
              "answers": [{"text": "All replicas will eventually have the same data",
                           "is_correct": True,
                           },
                          ...
                          {"text": "Data is never consistent",
                           "is_correct": False},
                          {"text": "Only one node has consistent data",
                           "is_correct": False},
                          ],
              },
             {"text": "What is a keyspace in Cassandra?",
              ...
              "points": 1,
              "answers": [{"text": "A container for tables that defines replication strategy",
                           "is_correct": True,
                           },
                          {"text": "A single row of data",
                           "is_correct": False},
                          {"text": "A backup file",
                           "is_correct": False},
             ...
             {"text": "What is compaction in Cassandra?",
              ...
              "points": 1,
              "answers": [{"text": "Merging SSTables to improve performance and reclaim space",
                           "is_correct": True,
                           },
                          {"text": "Compressing data to save disk space",
                           "is_correct": False},
                          {"text": "Creating database indexes",
                           "is_correct": False},
                          {"text": "Backing up database files",
                           "is_correct": False},
                          ],
              },
             ]
