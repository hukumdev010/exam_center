...
QUESTIONS = [{"text": "What is the primary methodology taught in the OSCP course?",
              ...
              "points": 1,
              "answers": [{"text": "Systematic penetration testing methodology",
                           "is_correct": True},
                          {"text": "Risk assessment framework",
                           "is_correct": False},
             ...
             {"text": "What is privilege escalation?",
              ...
              "points": 1,
              "answers": [{"text": "Gaining higher-level permissions on a compromised system",
                           "is_correct": True,
                           },
             ...
             {"text": "What is buffer overflow exploitation?",
              ...
              "points": 1,
              "answers": [{"text": "Overwriting memory to alter program execution",
                           "is_correct": True,
                           },
                          {"text": "Flooding networks with traffic",
                           "is_correct": False},
                          {"text": "Stealing user credentials",
                           "is_correct": False},
                          {"text": "Analyzing log files",
                           "is_correct": False},
                          ],
              },
             ]
