...
QUESTIONS = [{"text": "What is the purpose of a VLAN in network security?",
              ...
              "points": 1,
              "answers": [{"text": "Segment network traffic for improved security",
                           "is_correct": True,
                           },
             ...
             {"text": "What is the difference between IDS and IPS?",
              ...
              "points": 1,
              "answers": [{"text": "IDS detects and alerts; IPS detects and blocks",
                           "is_correct": True,
                           },
                          {"text": "IDS blocks threats; IPS only monitors",
                           "is_correct": False},
                          {"text": "They are the same thing",
                           "is_correct": False},
                          {"text": "IDS is hardware; IPS is software",
                           "is_correct": False},
                          ],
              },
             {"text": "Which type of attack involves redirecting network traffic?",
              ...
              "points": 1,
              "answers": [{"text": "Man-in-the-middle attack",
                           "is_correct": True},
                          {"text": "DDoS attack",
                           "is_correct": False},
             ...
             {"text": "What is network access control (NAC)?",
              ...
              "points": 1,
              "answers": [{"text": "Security approach to control device access to network resources",
                           "is_correct": True,
                           },
