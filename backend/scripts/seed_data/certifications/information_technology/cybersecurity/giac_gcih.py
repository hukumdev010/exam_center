...
QUESTIONS = [{"text": "What is the first step in the incident response process?",
             ...
             {"text": "What is the purpose of forensic imaging?",
              ...
              "points": 1,
              "answers": [{"text": "Create exact copies of storage media for analysis",
                           "is_correct": True,
                           },
                          {"text": "Enhance image quality",
                           "is_correct": False},
                          {"text": "Compress files",
                           "is_correct": False},
             ...
             {"text": "What is indicators of compromise (IoCs)?",
              ...
              "points": 1,
              "answers": [{"text": "Forensic artifacts that indicate potential security breaches",
                           "is_correct": True,
                           },
                          {"text": "Software vulnerabilities",
                           "is_correct": False},
                          {"text": "Network configuration errors",
                           "is_correct": False},
