...
QUESTIONS = [
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Peek", "is_correct": False},
            {"text": "Random access", "is_correct": True},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "O(1) amortized", "is_correct": True},
            {"text": "O(n) always", "is_correct": False},
            {"text": "O(log n)", "is_correct": False},
            {"text": "O(n²)", "is_correct": False},
        ],
    },
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Pre-order", "is_correct": False},
            {"text": "In-order", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "2^h - 1", "is_correct": False},
            {"text": "2^h", "is_correct": True},
            {"text": "2^(h+1) - 1", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Double hashing", "is_correct": True},
            {"text": "Chaining", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Adjacency matrix", "is_correct": False},
            {"text": "Adjacency list", "is_correct": True},
            {"text": "Edge list", "is_correct": False},
            {"text": "Incidence matrix", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Array only", "is_correct": False},
            {"text": "Hash table only", "is_correct": False},
            {"text": "Hash table + Doubly linked list", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Balanced", "is_correct": True},
            {"text": "Perfect", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Faster operations", "is_correct": False},
            {"text": "Space reuse", "is_correct": True},
            {"text": "Simpler implementation", "is_correct": False},
            {"text": "Better memory locality", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "BFS", "is_correct": True},
            {"text": "Dijkstra's", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "2k", "is_correct": False},
            {"text": "2^k", "is_correct": True},
            {"text": "k²", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Insert at beginning", "is_correct": False},
            {"text": "Delete first node", "is_correct": False},
            {"text": "Find last node", "is_correct": True},
            {"text": "Insert after given node", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Number of collisions", "is_correct": False},
            {"text": "Number of elements / Table size", "is_correct": True},
            {"text": "Number of empty slots", "is_correct": False},
            {"text": "Average probe distance", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Post-order", "is_correct": True},
            {"text": "Level-order", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "O(n + k log n)", "is_correct": True},
            {"text": "O(n log n)", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Adjacency list", "is_correct": False},
            {"text": "Adjacency matrix", "is_correct": True},
            {"text": "Edge list", "is_correct": False},
            {"text": "Incidence matrix", "is_correct": False},
        ],
    },
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Insert at middle", "is_correct": False},
            {"text": "Insert at front", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Guarantees O(log n) operations", "is_correct": True},
            {"text": "Simpler to implement", "is_correct": False},
            {"text": "Supports more operations", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "O(log(m + n))", "is_correct": False},
            {"text": "O(max(m, n))", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "All nodes have exactly two children", "is_correct": False},
            {"text": "Left < Node < Right for all nodes", "is_correct": True},
            {"text": "Tree must be complete", "is_correct": False},
            {"text": "All leaves are at the same level", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {"text": "Array", "is_correct": False},
            {"text": "Hash table", "is_correct": False},
            {"text": "Segment tree", "is_correct": True},
            {"text": "Linked list", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Deterministic", "is_correct": False},
            {"text": "Fast computation", "is_correct": False},
            {"text": "Uniform distribution", "is_correct": True},
            {"text": "Reversible", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Slow operations", "is_correct": False},
            {"text": "Fixed size", "is_correct": True},
            {"text": "Complex implementation", "is_correct": False},
            {"text": "Poor memory locality", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Kahn's algorithm", "is_correct": True},
            {"text": "Floyd-Warshall", "is_correct": False},
            {"text": "Prim's algorithm", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {"text": "n", "is_correct": False},
            {"text": "n-1", "is_correct": False},
            {"text": "n(n-1)/2", "is_correct": False},
            {"text": "n(n-1)", "is_correct": True},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Priority queue-based", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Extract minimum", "is_correct": False},
            {"text": "Find minimum", "is_correct": False},
            {"text": "Search arbitrary element", "is_correct": True},
        ],
    },
    {
        ...
        "answers": [
            {"text": "Uses less memory", "is_correct": False},
            {"text": "Bidirectional traversal", "is_correct": True},
            {"text": "Faster search", "is_correct": False},
            {"text": "Simpler implementation", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {"text": "n", "is_correct": False},
            {"text": "2n - 2", "is_correct": False},
            {"text": "3n/2 - 2", "is_correct": True},
            {"text": "n log n", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {"text": "Chaining", "is_correct": False},
            {"text": "Linear probing", "is_correct": True},
            {"text": "Double hashing", "is_correct": False},
            {"text": "Cuckoo hashing", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Splitting", "is_correct": False},
            {"text": "Rotation", "is_correct": True},
            {"text": "Merging", "is_correct": False},
            {"text": "Swapping", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Insert only", "is_correct": False},
            {"text": "Search only", "is_correct": False},
            {"text": "All operations", "is_correct": True},
            {"text": "Delete only", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {"text": "h", "is_correct": False},
            {"text": "2^h", "is_correct": False},
            {"text": "2^(h+1) - 1", "is_correct": True},
            {"text": "2h + 1", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "BFS only", "is_correct": False},
            {"text": "DFS", "is_correct": True},
            {"text": "Dijkstra's algorithm", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Node values", "is_correct": False},
            {"text": "Node colors", "is_correct": True},
            {"text": "Node weights", "is_correct": False},
            {"text": "Node priorities", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {"text": "O(1)", "is_correct": False},
            {"text": "O(log n) average", "is_correct": True},
            {"text": "O(n) always", "is_correct": False},
            {"text": "O(n²)", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Insertion sort", "is_correct": True},
            {"text": "Heap sort", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Less memory usage", "is_correct": False},
            {"text": "Faster average operations", "is_correct": True},
            {"text": "Maintains sorted order", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "interface TreeNode<T> { value: T; left?: TreeNode<T>; right?: TreeNode<T>; }",
                "is_correct": True,
            },
            {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "class HashMap<K, V> { private map = new Map<K, V>(); }",
                "is_correct": True,
            },
            {
    ...
    },
    {
        ...
        "points": 2,
        "answers": [
            {"text": "class BST<T extends Comparable<T>>", "is_correct": True},
            {"text": "class BST<T extends any>", "is_correct": False},
            {"text": "class BST<T extends object>", "is_correct": False},
            {"text": "class BST<T extends string | number>", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 3,
        "answers": [
            {"text": "A,B,D,C", "is_correct": True},
            {"text": "A,C,B,D", "is_correct": False},
            {"text": "A,B,C,D", "is_correct": False},
            {"text": "D,B,C,A", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "function isValidBST(root: TreeNode | null, min = -Infinity, max = Infinity): boolean {\n  if (!root) return True;\n  if (root.val <= min || root.val >= max) return False;\n  return isValidBST(root.left, min, root.val) && isValidBST(root.right, root.val, max);\n}",
                "is_correct": True,
            },
            {
    ...
    },
    {
        ...
        "points": 2,
        "answers": [
            {"text": "O(n log k)", "is_correct": True},
            {"text": "O(n log n)", "is_correct": False},
            {"text": "O(nk)", "is_correct": False},
            {"text": "O(k)", "is_correct": False},
        ],
    },
    {
        ...
        "points": 2,
        "answers": [
            {"text": "type Color = 'RED' | 'BLACK';", "is_correct": True},
            {"text": "type Color = boolean;", "is_correct": False},
            {"text": "type Color = 0 | 1 | 2;", "is_correct": False},
            {"text": "type Color = string;", "is_correct": False},
        ],
    },
    {
        ...
        "points": 3,
        "answers": [
            {"text": "[3, 3, 5, 5, 6, 7]", "is_correct": True},
            {"text": "[1, 3, 5, 5, 6, 7]", "is_correct": False},
            {"text": "[3, 3, 3, 5, 6, 7]", "is_correct": False},
            {"text": "[1, 1, -1, 3, 5, 6]", "is_correct": False},
        ],
    },
    {
