...
QUESTIONS = [{"text": "What is the time complexity of finding the Longest Common Subsequence using dynamic programming?",
             ...
             {"text": "Which technique is most effective for solving problems with optimal substructure?",
              ...
              "points": 1,
              "answers": [{"text": "Greedy algorithms",
                           "is_correct": False},
             ...
             {"text": "Which TypeScript implementation correctly solves the coin change problem using dynamic programming?",
              ...
              "points": 3,
              "answers": [{"text": "function coinChange(coins: number[], amount: number): number {\n    const dp = new Array(amount + 1).fill(Infinity);\n    dp[0] = 0;\n    \n    for (let i = 1; i <= amount; i++) {\n        for (const coin of coins) {\n            if (coin <= i) {\n                dp[i] = Math.min(dp[i], dp[i - coin] + 1);\n            }\n        }\n    }\n    \n    return dp[amount] === Infinity ? -1 : dp[amount];\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly finds the Longest Increasing Subsequence (LIS)?",
              ...
              "points": 3,
              "answers": [{"text": "function lengthOfLIS(nums: number[]): number {\n    const tails: number[] = [];\n    \n    for (const num of nums) {\n        let left = 0, right = tails.length;\n        \n        while (left < right) {\n            const mid = Math.floor((left + right) / 2);\n            if (tails[mid] < num) {\n                left = mid + 1;\n            } else {\n                right = mid;\n            }\n        }\n        \n        if (left === tails.length) {\n            tails.push(num);\n        } else {\n            tails[left] = num;\n        }\n    }\n    \n    return tails.length;\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly solves the 0/1 Knapsack problem?",
              ...
              "points": 3,
              "answers": [{"text": "function knapsack(weights: number[], values: number[], capacity: number): number {\n    const n = weights.length;\n    const dp = Array(n + 1).fill(null).map(() => Array(capacity + 1).fill(0));\n    \n    for (let i = 1; i <= n; i++) {\n        for (let w = 1; w <= capacity; w++) {\n            if (weights[i - 1] <= w) {\n                dp[i][w] = Math.max(\n                    dp[i - 1][w],\n                    dp[i - 1][w - weights[i - 1]] + values[i - 1]\n                );\n            } else {\n                dp[i][w] = dp[i - 1][w];\n            }\n        }\n    }\n    \n    return dp[n][capacity];\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly solves the Longest Common Subsequence problem?",
              ...
              "reference": "https://en.wikipedia.org/wiki/Longest_common_subsequence_problem",
              "points": 3,
              "answers": [{"text": "function lcs(str1: string, str2: string): number {\n    const m = str1.length;\n    const n = str2.length;\n    const dp = Array(m + 1).fill(null).map(() => Array(n + 1).fill(0));\n    \n    for (let i = 1; i <= m; i++) {\n        for (let j = 1; j <= n; j++) {\n            if (str1[i - 1] === str2[j - 1]) {\n                dp[i][j] = dp[i - 1][j - 1] + 1;\n            } else {\n                dp[i][j] = Math.max(dp[i - 1][j], dp[i][j - 1]);\n            }\n        }\n    }\n    \n    return dp[m][n];\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly solves the Matrix Chain Multiplication problem?",
              ...
              "points": 4,
              "answers": [{"text": "function matrixChainOrder(dimensions: number[]): number {\n    const n = dimensions.length - 1;\n    const dp = Array(n).fill(null).map(() => Array(n).fill(0));\n    \n    for (let len = 2; len <= n; len++) {\n        for (let i = 0; i <= n - len; i++) {\n            const j = i + len - 1;\n            dp[i][j] = Infinity;\n            \n            for (let k = i; k < j; k++) {\n                const cost = dp[i][k] + dp[k + 1][j] + \n                           dimensions[i] * dimensions[k + 1] * dimensions[j + 1];\n                dp[i][j] = Math.min(dp[i][j], cost);\n            }\n        }\n    }\n    \n    return dp[0][n - 1];\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly solves the Subset Sum problem using dynamic programming?",
              ...
              "points": 3,
              "answers": [{"text": "function subsetSum(nums: number[], target: number): boolean {\n    const dp = Array(target + 1).fill(False);\n    dp[0] = True;\n    \n    for (const num of nums) {\n        for (let j = target; j >= num; j--) {\n            dp[j] = dp[j] || dp[j - num];\n        }\n    }\n    \n    return dp[target];\n}",
                           "is_correct": True,
                           },
             ...
             {"text": "Which TypeScript implementation correctly solves the Longest Palindromic Subsequence problem?",
              ...
              "points": 3,
              "answers": [{"text": "function longestPalindromicSubsequence(s: string): number {\n    const n = s.length;\n    const dp = Array(n).fill(null).map(() => Array(n).fill(0));\n    \n    // Every single character is a palindrome of length 1\n    for (let i = 0; i < n; i++) {\n        dp[i][i] = 1;\n    }\n    \n    // Fill for lengths 2 to n\n    for (let len = 2; len <= n; len++) {\n        for (let i = 0; i <= n - len; i++) {\n            const j = i + len - 1;\n            if (s[i] === s[j]) {\n                dp[i][j] = dp[i + 1][j - 1] + 2;\n            } else {\n                dp[i][j] = Math.max(dp[i + 1][j], dp[i][j - 1]);\n            }\n        }\n    }\n    \n    return dp[0][n - 1];\n}",
                           "is_correct": True,
                           },
