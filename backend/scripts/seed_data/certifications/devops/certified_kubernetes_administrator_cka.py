...
QUESTIONS = [{"text": "What is a Pod in Kubernetes?",
              ...
              "points": 1,
              "answers": [{"text": "A Kubernetes cluster",
                           "is_correct": False},
             ...
             {"text": "What is the purpose of a Kubernetes Service?",
              ...
              "points": 1,
              "answers": [{"text": "To store persistent data",
                           "is_correct": False},
                          {"text": "To provide stable networking and load balancing for Pods",
                           "is_correct": True,
                           },
                          {"text": "To manage container images",
                           "is_correct": False},
                          {"text": "To schedule workloads",
                           "is_correct": False},
                          ],
              },
             {"text": "What is kubectl?",
              ...
              "points": 1,
              "answers": [{"text": "A container runtime",
                           "is_correct": False},
                          {"text": "The Kubernetes command-line tool",
                           "is_correct": True},
             ...
             {"text": "What is a Deployment in Kubernetes?",
              ...
              "points": 1,
              "answers": [{"text": "A type of storage volume",
                           "is_correct": False},
                          {"text": "A controller for managing Pod replicas and updates",
                           "is_correct": True,
                           },
                          {"text": "A networking policy",
                           "is_correct": False},
                          {"text": "A security configuration",
                           "is_correct": False},
                          ],
              },
             {"text": "What is a Namespace in Kubernetes?",
              ...
              "points": 1,
              "answers": [{"text": "A container image repository",
                           "is_correct": False},
                          {"text": "A way to isolate groups of resources within a cluster",
                           "is_correct": True,
                           },
                          {"text": "A type of persistent volume",
                           "is_correct": False},
                          {"text": "A load balancing mechanism",
                           "is_correct": False},
                          ],
              },
             ]
