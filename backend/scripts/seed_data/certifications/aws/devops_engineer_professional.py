...
QUESTIONS = [
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Monitoring and logging", "is_correct": True},
            {"text": "Code deployment", "is_correct": False},
            {"text": "Infrastructure provisioning", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Storing configuration data and secrets", "is_correct": True},
            {"text": "Building applications", "is_correct": False},
            {"text": "Monitoring metrics", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Amazon ECS or EKS", "is_correct": True},
            {"text": "AWS Lambda", "is_correct": False},
            {"text": "Amazon EC2", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Auditing and logging API calls", "is_correct": True},
            {"text": "Application monitoring", "is_correct": False},
            {"text": "Code deployment", "is_correct": False},
            {"text": "Resource provisioning", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Deploying and scaling web applications", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Automatically adjusting capacity based on demand",
                "is_correct": True,
            },
            {"text": "Reducing security vulnerabilities", "is_correct": False},
            {"text": "Improving code quality", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Configuration management and compliance", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "OneAtATime", "is_correct": True},
            {"text": "HalfAtATime", "is_correct": False},
            {"text": "AllAtOnce", "is_correct": False},
            {"text": "BlueGreen", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Deploy stacks across multiple accounts and regions",
                "is_correct": True,
            },
            {"text": "Monitor stack performance", "is_correct": False},
            {"text": "Backup stack configurations", "is_correct": False},
            {"text": "Optimize stack costs", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing software development projects", "is_correct": True},
            {"text": "Monitoring applications", "is_correct": False},
            {"text": "Storing code repositories", "is_correct": False},
            {"text": "Deploying infrastructure", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing and rotating secrets securely", "is_correct": True},
            {"text": "Building applications", "is_correct": False},
            {"text": "Monitoring performance", "is_correct": False},
            {"text": "Managing user identities", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Distributed application tracing and debugging",
                "is_correct": True,
            },
            {"text": "Code compilation", "is_correct": False},
            {"text": "Resource provisioning", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Secure shell access to EC2 instances", "is_correct": True},
            {"text": "Managing application configurations", "is_correct": False},
            {"text": "Monitoring system performance", "is_correct": False},
            {"text": "Deploying applications", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing software packages and dependencies", "is_correct": True},
            {"text": "Building applications", "is_correct": False},
            {"text": "Deploying code", "is_correct": False},
            {"text": "Monitoring applications", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Rolling deployment", "is_correct": False},
            {"text": "All-at-once deployment", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Configuration management with Chef and Puppet",
                "is_correct": True,
            },
            {"text": "Code deployment", "is_correct": False},
            {"text": "Database management", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Detect configuration changes outside of CloudFormation",
                "is_correct": True,
            },
            {"text": "Monitor stack performance", "is_correct": False},
            {"text": "Optimize stack costs", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Code quality analysis and performance optimization",
                "is_correct": True,
            },
            {"text": "Code compilation", "is_correct": False},
            {"text": "Code deployment", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing catalogs of approved IT services", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Setting up and governing multi-account AWS environments",
                "is_correct": True,
            },
            {"text": "Managing single AWS accounts", "is_correct": False},
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Deploying applications", "is_correct": False},
        ],
    },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Service mesh for microservices communication",
                "is_correct": True,
            },
            {"text": "Application deployment", "is_correct": False},
            {"text": "Database management", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "AI-powered code generation and suggestions", "is_correct": True},
            {"text": "Code compilation", "is_correct": False},
            {"text": "Code deployment", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Consistent and repeatable infrastructure deployments",
                "is_correct": True,
            },
            {"text": "Reduced infrastructure costs", "is_correct": False},
            {"text": "Improved application performance", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Centrally managing multiple AWS accounts", "is_correct": True},
            {"text": "Managing user identities", "is_correct": False},
            {"text": "Monitoring account usage", "is_correct": False},
            {"text": "Deploying applications", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "BeforeStop", "is_correct": True},
            {"text": "AfterStop", "is_correct": False},
            {"text": "BeforeInstall", "is_correct": False},
            {"text": "ApplicationStart", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Policy-as-code validation for CloudFormation templates",
                "is_correct": True,
            },
            {"text": "Monitoring CloudFormation stacks", "is_correct": False},
            {"text": "Deploying CloudFormation templates", "is_correct": False},
            {"text": "Optimizing CloudFormation costs", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Organizing and managing related AWS resources",
                "is_correct": True,
            },
            {"text": "Monitoring resource performance", "is_correct": False},
            {"text": "Deploying resources", "is_correct": False},
            {"text": "Encrypting resources", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Managing software licenses across environments",
                "is_correct": True,
            },
            {"text": "Managing AWS service licenses", "is_correct": False},
            {"text": "Monitoring license costs", "is_correct": False},
            {"text": "Deploying licensed software", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "AWS Systems Manager Change Calendar", "is_correct": True},
            {"text": "AWS Config", "is_correct": False},
            {"text": "AWS CloudTrail", "is_correct": False},
            {"text": "AWS Service Catalog", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Managing application deployment infrastructure",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Building applications", "is_correct": False},
            {"text": "Testing applications", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Providing best practices for cloud architecture",
                "is_correct": True,
            },
            {"text": "Monitoring architecture performance", "is_correct": False},
            {"text": "Deploying cloud resources", "is_correct": False},
            {"text": "Managing cloud costs", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Unified software development and delivery", "is_correct": True},
            {"text": "Code analysis and review", "is_correct": False},
            {"text": "Code storage and versioning", "is_correct": False},
            {"text": "Code compilation and testing", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Amazon Managed Grafana", "is_correct": True},
            {"text": "Amazon CloudWatch", "is_correct": False},
            {"text": "Amazon QuickSight", "is_correct": False},
            {"text": "Amazon OpenSearch", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Visual building of serverless applications", "is_correct": True},
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Testing applications", "is_correct": False},
            {"text": "Deploying applications", "is_correct": False},
        ],
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Sharing AWS resources across accounts", "is_correct": True},
            {"text": "Managing resource permissions", "is_correct": False},
            {"text": "Monitoring resource usage", "is_correct": False},
            {"text": "Optimizing resource costs", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Testing application resilience through controlled failures",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Deploying applications", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Serverless container execution without managing servers",
                "is_correct": True,
            },
            {"text": "Improved container performance", "is_correct": False},
            {"text": "Reduced container costs", "is_correct": False},
            {"text": "Enhanced container security", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Public internet connectivity", "is_correct": False},
            {"text": "VPN connections", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Automated data transfer between storage systems",
                "is_correct": True,
            },
            {"text": "Real-time data streaming", "is_correct": False},
            {"text": "Data backup and archival", "is_correct": False},
            {"text": "Data analysis and processing", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Providing optimization recommendations for AWS resources",
                "is_correct": True,
            },
            {"text": "Managing AWS support cases", "is_correct": False},
            {"text": "Monitoring AWS service health", "is_correct": False},
            {"text": "Billing and cost management", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Analyzing AWS costs and usage patterns", "is_correct": True},
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing resource deployments", "is_correct": False},
            {"text": "Optimizing infrastructure", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Connecting VPCs and on-premises networks", "is_correct": True},
            {"text": "Load balancing traffic", "is_correct": False},
            {"text": "Managing DNS routing", "is_correct": False},
            {"text": "Monitoring network performance", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing user directories and access", "is_correct": True},
            {"text": "Storing application data", "is_correct": False},
            {"text": "Managing file systems", "is_correct": False},
            {"text": "Monitoring user activity", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Amazon Kinesis Data Analytics", "is_correct": True},
            {"text": "Amazon EMR", "is_correct": False},
            {"text": "AWS Glue", "is_correct": False},
            {"text": "Amazon Redshift", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Monitoring AWS service health affecting your resources",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing user health data", "is_correct": False},
            {"text": "Tracking resource costs", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Centrally managing SSO access to AWS accounts and applications",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Amazon MemoryDB for Redis", "is_correct": True},
            {"text": "Amazon ElastiCache", "is_correct": False},
            {"text": "Amazon DynamoDB", "is_correct": False},
            {"text": "Amazon RDS", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Improving application availability and performance globally",
                "is_correct": True,
            },
            {"text": "Accelerating data processing", "is_correct": False},
            {"text": "Speeding up deployments", "is_correct": False},
            {"text": "Optimizing storage performance", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Large-scale data transfer using physical appliances",
                "is_correct": True,
            },
            {"text": "Real-time data streaming", "is_correct": False},
            {"text": "Data backup and archival", "is_correct": False},
            {"text": "Data processing and analytics", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Amazon WorkSpaces", "is_correct": True},
            {"text": "Amazon EC2", "is_correct": False},
            {"text": "AWS Lambda", "is_correct": False},
            {"text": "Amazon ECS", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Easily deploying containerized web applications",
                "is_correct": True,
            },
            {"text": "Running batch processing jobs", "is_correct": False},
            {"text": "Managing databases", "is_correct": False},
            {"text": "Monitoring applications", "is_correct": False},
        ],
    },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Building and deploying full-stack web and mobile applications",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing databases", "is_correct": False},
            {"text": "Processing data streams", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Discovering and protecting sensitive data", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Centrally managing security findings and compliance",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing user identities", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Protecting web applications from common attacks",
                "is_correct": True,
            },
            {"text": "Managing network firewalls", "is_correct": False},
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing user access", "is_correct": False},
        ],
    },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Automated security assessment of applications",
                "is_correct": True,
            },
            {"text": "Monitoring application performance", "is_correct": False},
            {"text": "Managing user access", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "DDoS protection for applications", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Managing SSL/TLS certificates", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Hardware-based cryptographic operations and key storage",
                "is_correct": True,
            },
            {"text": "Software-based encryption", "is_correct": False},
            {"text": "Identity management", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "AWS Infrastructure Event Management", "is_correct": True},
            {"text": "AWS Config", "is_correct": False},
            {"text": "AWS CloudWatch Events", "is_correct": False},
