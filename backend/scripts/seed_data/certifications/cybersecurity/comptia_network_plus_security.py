...
QUESTIONS = [
    {
        ...
        "answers": [
            {
                "text": "Segment network traffic for improved security",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "IDS detects and alerts; IPS detects and blocks",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Security approach to control device access to network resources",
                "is_correct": True,
            },
