...
QUESTIONS = [
    {
        ...
        "answers": [
            {
                "text": "Monitor and respond to security incidents 24/7",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Data about potential security threats and attackers",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Train security personnel", "is_correct": False},
            {"text": "Purchase security software", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Simulate attacks to identify vulnerabilities",
                "is_correct": True,
            },
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Trust but verify", "is_correct": False},
            {"text": "Default allow policy", "is_correct": False},
            {"text": "Perimeter-based security", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Long-term, sophisticated attacks with sustained access",
                "is_correct": True,
            },
            {"text": "Quick hit-and-run attacks", "is_correct": False},
            {"text": "Automated vulnerability scans", "is_correct": False},
            {"text": "Social engineering campaigns", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Security awareness training", "is_correct": True},
            {"text": "Firewall configuration", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Aggregate and analyze security events for threat detection",
                "is_correct": True,
            },
            {"text": "Backup data automatically", "is_correct": False},
            {"text": "Manage user passwords", "is_correct": False},
            {"text": "Control network access", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "ITIL Framework", "is_correct": False},
            {"text": "Agile Framework", "is_correct": False},
            {"text": "PMBOK Framework", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Analyze digital evidence to understand security incidents",
                "is_correct": True,
            },
            {"text": "Prevent future attacks", "is_correct": False},
            {"text": "Install security updates", "is_correct": False},
            {"text": "Monitor network performance", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Ensure business operations continue during and after incidents",
                "is_correct": True,
            },
            {"text": "Prevent all security incidents", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Authenticated vulnerability scan", "is_correct": True},
            {"text": "Unauthenticated external scan", "is_correct": False},
            {"text": "Network discovery scan", "is_correct": False},
            {"text": "Port scan", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Automate security operations and incident response",
                "is_correct": True,
            },
            {"text": "Replace security analysts", "is_correct": False},
            {"text": "Monitor network bandwidth", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Security through obscurity", "is_correct": False},
            {"text": "Security as an afterthought", "is_correct": False},
            {"text": "Security by compliance", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Limit threat spread and reduce attack surface",
                "is_correct": True,
            },
            {"text": "Improve network performance", "is_correct": False},
            {"text": "Reduce hardware costs", "is_correct": False},
            {"text": "Simplify network management", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Define access rights and permissions for resources",
                "is_correct": True,
            },
            {"text": "Monitor network traffic", "is_correct": False},
            {"text": "Encrypt sensitive data", "is_correct": False},
            {"text": "Backup user files", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Defense in Depth", "is_correct": False},
            {"text": "Separation of Duties", "is_correct": False},
            {"text": "Need to Know", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Issue and manage digital certificates", "is_correct": True},
            {"text": "Generate encryption keys", "is_correct": False},
            {"text": "Monitor network traffic", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Denial of Service (DoS)", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Determine appropriate security controls for different data types",
                "is_correct": True,
            },
            {"text": "Reduce storage costs", "is_correct": False},
            {"text": "Improve data retrieval speed", "is_correct": False},
            {"text": "Organize files alphabetically", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Bell-LaPadula model", "is_correct": True},
            {"text": "Biba model", "is_correct": False},
            {"text": "Clark-Wilson model", "is_correct": False},
            {"text": "Chinese Wall model", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Educate employees about cybersecurity threats and safe practices",
                "is_correct": True,
            },
            {"text": "Install security software", "is_correct": False},
            {"text": "Configure firewalls", "is_correct": False},
            {"text": "Monitor network logs", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Hot backup", "is_correct": True},
            {"text": "Cold backup", "is_correct": False},
            {"text": "Warm backup", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Monitor and detect suspicious network activities",
                "is_correct": True,
            },
            {"text": "Block malicious traffic", "is_correct": False},
            {"text": "Encrypt network communications", "is_correct": False},
            {"text": "Manage user accounts", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Digital signatures with encryption", "is_correct": True},
            {"text": "Hash functions only", "is_correct": False},
            {"text": "Symmetric encryption only", "is_correct": False},
            {"text": "Public key encryption only", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Establish minimum security configuration standards",
                "is_correct": True,
            },
            {"text": "Monitor system performance", "is_correct": False},
            {"text": "Create user accounts", "is_correct": False},
            {"text": "Install software updates", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Separation of Duties", "is_correct": True},
            {"text": "Least Privilege", "is_correct": False},
            {"text": "Defense in Depth", "is_correct": False},
            {"text": "Need to Know", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Systematically identify and remediate security vulnerabilities",
                "is_correct": True,
            },
            {"text": "Install antivirus software", "is_correct": False},
            {"text": "Monitor network bandwidth", "is_correct": False},
            {"text": "Manage user passwords", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Deterrent controls", "is_correct": True},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Measure security program effectiveness and support decision-making",
                "is_correct": True,
            },
            {"text": "Install security patches", "is_correct": False},
            {"text": "Configure firewall rules", "is_correct": False},
            {"text": "Train security personnel", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Cross-Site Request Forgery (CSRF)", "is_correct": True},
            {"text": "SQL Injection", "is_correct": False},
            {"text": "Buffer Overflow", "is_correct": False},
            {"text": "Directory Traversal", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Significantly strengthen authentication security",
                "is_correct": True,
            },
            {"text": "Reduce login time", "is_correct": False},
            {"text": "Eliminate password requirements", "is_correct": False},
            {"text": "Improve system performance", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Protect stored data from unauthorized access",
                "is_correct": True,
            },
            {"text": "Improve database performance", "is_correct": False},
            {"text": "Reduce storage space", "is_correct": False},
            {"text": "Speed up data retrieval", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Whaling", "is_correct": True},
            {"text": "Spear phishing", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Protect web applications from application-layer attacks",
                "is_correct": True,
            },
            {"text": "Improve website loading speed", "is_correct": False},
            {"text": "Manage SSL certificates", "is_correct": False},
            {"text": "Optimize database queries", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Kerckhoffs's principle", "is_correct": True},
            {"text": "Defense in depth", "is_correct": False},
            {"text": "Least privilege", "is_correct": False},
            {"text": "Fail-safe defaults", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Uses multiple compromised systems to flood the target",
                "is_correct": True,
            },
            {"text": "Targets only web applications", "is_correct": False},
            {"text": "Only affects network infrastructure", "is_correct": False},
            {"text": "Requires physical access to systems", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Monitor and respond to threats on endpoint devices",
                "is_correct": True,
            },
            {"text": "Manage software updates", "is_correct": False},
            {"text": "Control network access", "is_correct": False},
            {"text": "Backup endpoint data", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "SQL injection", "is_correct": True},
            {"text": "Cross-site scripting", "is_correct": False},
            {"text": "Buffer overflow", "is_correct": False},
            {"text": "Command injection", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Improve collective defense through shared threat intelligence",
                "is_correct": True,
            },
            {"text": "Reduce security costs", "is_correct": False},
            {"text": "Comply with regulations", "is_correct": False},
            {"text": "Simplify security management", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Design and implement comprehensive security controls",
                "is_correct": True,
            },
            {"text": "Reduce operational costs", "is_correct": False},
            {"text": "Improve system performance", "is_correct": False},
            {"text": "Simplify user interfaces", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Corrective controls", "is_correct": True},
            {"text": "Preventive controls", "is_correct": False},
            {"text": "Detective controls", "is_correct": False},
            {"text": "Deterrent controls", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Provide additional authentication factor beyond passwords",
                "is_correct": True,
            },
            {"text": "Store user preferences", "is_correct": False},
            {"text": "Encrypt network traffic", "is_correct": False},
            {"text": "Monitor user activities", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Ransomware", "is_correct": True},
            {"text": "Spyware", "is_correct": False},
            {"text": "Adware", "is_correct": False},
            {"text": "Keylogger", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Prevent security vulnerabilities during development",
                "is_correct": True,
            },
            {"text": "Improve code performance", "is_correct": False},
            {"text": "Reduce development time", "is_correct": False},
            {"text": "Simplify code maintenance", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Static Application Security Testing (SAST)", "is_correct": True},
            {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Limit the scope and impact of the security incident",
                "is_correct": True,
            },
            {"text": "Identify the root cause", "is_correct": False},
            {"text": "Restore normal operations", "is_correct": False},
            {"text": "Document lessons learned", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Transport Layer Security (TLS)", "is_correct": True},
            {"text": "File Transfer Protocol (FTP)", "is_correct": False},
            {"text": "Simple Mail Transfer Protocol (SMTP)", "is_correct": False},
            {"text": "Hypertext Transfer Protocol (HTTP)", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Establish rules and guidelines for protecting information assets",
                "is_correct": True,
            },
            {"text": "Configure security software", "is_correct": False},
            {"text": "Monitor network traffic", "is_correct": False},
            {"text": "Train security personnel", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Social engineering", "is_correct": True},
            {"text": "Password cracking", "is_correct": False},
            {"text": "Network scanning", "is_correct": False},
            {"text": "Vulnerability exploitation", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Control and manage access to network resources",
                "is_correct": True,
            },
            {"text": "Monitor network performance", "is_correct": False},
            {"text": "Encrypt network traffic", "is_correct": False},
            {"text": "Backup network configurations", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Differential backup", "is_correct": True},
            {"text": "Incremental backup", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Align security strategies with business objectives",
                "is_correct": True,
            },
            {"text": "Install security software", "is_correct": False},
            {"text": "Configure firewalls", "is_correct": False},
            {"text": "Train security staff", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Digital signatures", "is_correct": True},
            {"text": "Symmetric encryption", "is_correct": False},
            {"text": "Hash functions", "is_correct": False},
            {"text": "Access control lists", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Continuously detect and respond to security threats",
                "is_correct": True,
            },
            {"text": "Improve system performance", "is_correct": False},
            {"text": "Reduce operational costs", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Application layer firewall", "is_correct": True},
            {"text": "Packet filtering firewall", "is_correct": False},
            {"text": "Stateful inspection firewall", "is_correct": False},
            {"text": "Circuit-level gateway", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            ...
            {"text": "Reduce storage costs", "is_correct": False},
            {"text": "Optimize database performance", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Fail-safe defaults", "is_correct": True},
            {"text": "Defense in depth", "is_correct": False},
            {"text": "Least privilege", "is_correct": False},
            {"text": "Complete mediation", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Identify and assess potential threats to systems",
                "is_correct": True,
            },
            {"text": "Install security patches", "is_correct": False},
            {"text": "Monitor network traffic", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Man-in-the-Middle (MITM)", "is_correct": True},
            {"text": "Replay attack", "is_correct": False},
            {"text": "Brute force attack", "is_correct": False},
            {"text": "Dictionary attack", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Provide secure remote access to private networks",
                "is_correct": True,
            },
            {"text": "Improve internet speed", "is_correct": False},
            {"text": "Block malicious websites", "is_correct": False},
            {"text": "Monitor network traffic", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Securely generate, store, and manage cryptographic keys",
                "is_correct": True,
            },
            {"text": "Monitor network traffic", "is_correct": False},
            {"text": "Backup system data", "is_correct": False},
            {"text": "Manage user accounts", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Complete mediation", "is_correct": True},
            {"text": "Least privilege", "is_correct": False},
            {"text": "Defense in depth", "is_correct": False},
            {"text": "Separation of duties", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Isolate and safely execute potentially malicious code",
                "is_correct": True,
            },
            {"text": "Improve system performance", "is_correct": False},
            {"text": "Backup important files", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Cryptanalysis", "is_correct": True},
            {"text": "Brute force attack", "is_correct": False},
            {"text": "Social engineering", "is_correct": False},
            {"text": "Physical attack", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Remove the threat and eliminate traces of the attack",
                "is_correct": True,
            },
            {"text": "Document the incident", "is_correct": False},
            {"text": "Notify stakeholders", "is_correct": False},
            {"text": "Assess the damage", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Intrusion Prevention System (IPS)", "is_correct": True},
            {"text": "Antivirus software", "is_correct": False},
            {"text": "Access control list", "is_correct": False},
            {"text": "Audit log", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Store encryption keys with trusted third parties for recovery",
                "is_correct": True,
            },
            {"text": "Generate new encryption keys", "is_correct": False},
            {"text": "Distribute keys to users", "is_correct": False},
            {"text": "Validate key authenticity", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Broadcast storm", "is_correct": True},
            {"text": "ARP poisoning", "is_correct": False},
            {"text": "DNS spoofing", "is_correct": False},
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Exchange authentication and authorization data for SSO",
                "is_correct": True,
            },
            {"text": "Encrypt network communications", "is_correct": False},
            {"text": "Monitor system logs", "is_correct": False},
            {"text": "Manage user profiles", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Spyware", "is_correct": True},
            {"text": "Worm", "is_correct": False},
            {"text": "Logic bomb", "is_correct": False},
            {"text": "Boot sector virus", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Maintain consistent and secure system configurations",
                "is_correct": True,
            },
            {"text": "Monitor network performance", "is_correct": False},
            {"text": "Backup system data", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Biba model", "is_correct": True},
            {"text": "Bell-LaPadula model", "is_correct": False},
            {"text": "Clark-Wilson model", "is_correct": False},
            {"text": "Chinese Wall model", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Restore systems to normal operation and address vulnerabilities",
                "is_correct": True,
            },
            {"text": "Identify the attacker", "is_correct": False},
            {"text": "Calculate financial losses", "is_correct": False},
            {"text": "Update security policies", "is_correct": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "answers": [
            {
                "text": "Provide a buffer zone between internal and external networks",
                "is_correct": True,
            },
            {"text": "Improve network performance", "is_correct": False},
            {"text": "Reduce hardware costs", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Attribute-Based Access Control (ABAC)", "is_correct": True},
            {"text": "Role-Based Access Control (RBAC)", "is_correct": False},
            {"text": "Mandatory Access Control (MAC)", "is_correct": False},
            {"text": "Discretionary Access Control (DAC)", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Issue and manage security tokens for authentication",
                "is_correct": True,
            },
            {"text": "Monitor network traffic", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Buffer overflow attack", "is_correct": True},
            {"text": "Format string attack", "is_correct": False},
            {"text": "Race condition attack", "is_correct": False},
            {"text": "Integer overflow attack", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Measure effectiveness of security training programs",
                "is_correct": True,
            },
            {"text": "Monitor network performance", "is_correct": False},
            {"text": "Track system uptime", "is_correct": False},
            {"text": "Measure encryption strength", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "SFTP (Secure File Transfer Protocol)", "is_correct": True},
            {"text": "FTP (File Transfer Protocol)", "is_correct": False},
            {"text": "TFTP (Trivial File Transfer Protocol)", "is_correct": False},
            {"text": "HTTP (Hypertext Transfer Protocol)", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Identify vulnerabilities and security flaws before deployment",
                "is_correct": True,
            },
            {"text": "Improve application performance", "is_correct": False},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Three-factor authentication", "is_correct": True},
            {"text": "Two-factor authentication", "is_correct": False},
            {"text": "Single sign-on", "is_correct": False},
            {"text": "Mutual authentication", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "Detect security incidents and identify suspicious activity patterns",
                "is_correct": True,
            },
            {"text": "Improve system performance", "is_correct": False},
            {"text": "Reduce storage costs", "is_correct": False},
            {"text": "Simplify system administration", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Detective controls", "is_correct": True},
            {"text": "Preventive controls", "is_correct": False},
            {"text": "Corrective controls", "is_correct": False},
            {"text": "Compensating controls", "is_correct": False},
        ],
    },
    {
        ...
        "answers": [
            {
                "text": "List certificates that have been revoked and should not be trusted",
                "is_correct": True,
            },
            {"text": "Store valid certificates", "is_correct": False},
            {"text": "Generate new certificates", "is_correct": False},
            {"text": "Encrypt certificate data", "is_correct": False},
        ],
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Malformed packet attack", "is_correct": True},
            {"text": "Packet sniffing", "is_correct": False},
            {"text": "Packet replay", "is_correct": False},
            {"text": "Packet fragmentation", "is_correct": False},
        ],
    },
]
