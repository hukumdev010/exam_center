...
QUESTIONS = [{"text": "What is JSX in React?",
              ...
              "points": 1,
              "answers": [{"text": "A CSS preprocessor",
                           "is_correct": False},
                          {"text": "A syntax extension for JavaScript",
                           "is_correct": True},
                          {"text": "A React library",
                           "is_correct": False},
             ...
             {"text": "What is the purpose of React Hooks?",
              ...
              "points": 1,
              "answers": [{"text": "To style components",
                           "is_correct": False},
             ...
             {"text": "What is the Virtual DOM in React?",
              ...
              "points": 1,
              "answers": [{"text": "A real DOM element",
                           "is_correct": False},
                          {"text": "A JavaScript representation of the DOM",
                           "is_correct": True},
                          {"text": "A CSS framework",
                           "is_correct": False},
                          {"text": "A server-side rendering tool",
                           "is_correct": False},
                          ],
              },
             {"text": "What is the difference between props and state in React?",
              ...
              "points": 1,
              "answers": [{"text": "Props are mutable, state is immutable",
                           "is_correct": False},
                          {"text": "Props are passed from parent, state is managed within component",
                           "is_correct": True,
                           },
                          {"text": "Props and state are the same thing",
                           "is_correct": False},
                          {"text": "Props are for styling, state is for data",
                           "is_correct": False},
                          ],
              },
             {"text": "What is the useEffect Hook used for?",
              ...
              "points": 1,
              "answers": [{"text": "To manage component state",
                           "is_correct": False},
                          ...
                          {"text": "To handle form validation",
                           "is_correct": False},
                          {"text": "To create custom components",
                           "is_correct": False},
                          ],
              },
             ]
