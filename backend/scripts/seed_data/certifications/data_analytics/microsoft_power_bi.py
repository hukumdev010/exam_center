...
QUESTIONS = [{"text": "What is the primary purpose of Power Query in Power BI?",
              ...
              "points": 1,
              "answers": [{"text": "Data transformation and preparation",
                           "is_correct": True},
                          {"text": "Creating visualizations",
                           "is_correct": False},
                          {"text": "Managing user permissions",
                           "is_correct": False},
                          {"text": "Scheduling data refreshes",
                           "is_correct": False},
                          ],
              },
             {"text": "Which DAX function is used to calculate a running total?",
              ...
              "points": 1,
              "answers": [{"text": "CALCULATE with appropriate filters",
                           "is_correct": True},
                          {"text": "SUM",
                           "is_correct": False},
                          {"text": "COUNT",
             ...
             {"text": "What is the difference between DirectQuery and Import mode in Power BI?",
              ...
              "points": 1,
              "answers": [{"text": "Import loads data into memory; DirectQuery queries source in real-time",
                           "is_correct": True,
                           },
                          {"text": "They are the same thing",
                           "is_correct": False},
                          {"text": "DirectQuery is faster than Import",
                           "is_correct": False},
                          {"text": "Import requires more licenses",
                           "is_correct": False},
                          ],
              },
             ...
             {"text": "What is row-level security (RLS) in Power BI?",
              ...
              "points": 1,
              "answers": [{"text": "Restricting data access at the row level based on user roles",
                           "is_correct": True,
                           },
                          {"text": "Encrypting data in transit",
                           "is_correct": False},
                          {"text": "Backing up data rows",
                           "is_correct": False},
