...
QUESTIONS = [
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Generate frequency tables and cross-tabulations", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Assignment statement (variable = expression)", "is_correct": True},
    ...
    },
    {
        ...
        "points": 1,
        "answers": [
            {"text": "Process data separately for each unique value of specified variables", "is_correct": True},
