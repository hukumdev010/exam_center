...
QUESTIONS = [{"text": "What is the Qlik Associative Model?",
              ...
              "points": 1,
              "answers": [{"text": "A data model that maintains associations between all data elements",
                           "is_correct": True,
                           },
                          {"text": "A relational database structure",
                           "is_correct": False},
             ...
             {"text": "What is a synthetic key in Qlik Sense?",
              ...
              "points": 1,
              "answers": [{"text": "An automatically created key when tables share multiple common fields",
                           "is_correct": True,
                           },
                          {"text": "A manually created primary key",
                           "is_correct": False},
                          {"text": "An encrypted field",
                           "is_correct": False},
                          {"text": "A calculated dimension",
                           "is_correct": False},
                          ],
              },
             {"text": "What is the purpose of the Set Analysis in Qlik Sense?",
              ...
              "points": 1,
              "answers": [{"text": "Define a set of data different from current selections for calculations",
                           "is_correct": True,
                           },
             ...
             {"text": "Which Qlik Sense feature provides data lineage and impact analysis?",
              ...
              "points": 1,
              "answers": [{"text": "Data Manager and Data Model Viewer",
                           "is_correct": True},
                          {"text": "Set Analysis",
                           "is_correct": False},
                          {"text": "Master Items",
