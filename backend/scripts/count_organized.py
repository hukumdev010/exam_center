...
def count_organized_certifications():
    ...
    for category, stats in sorted(category_stats.items()):
        ...
        print(f"{type_indicator} {category_name}: {cert_count} certifications, {question_count} sample questions")
    ...
    # Show new categories
    new_categories = [cat for cat in category_stats.keys() if cat in ['linux', 'system_design']]
    if new_categories:
