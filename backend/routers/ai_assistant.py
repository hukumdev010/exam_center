...
Be conversational, encouraging, and educational in your responses."""
        ...
        full_prompt = f"{system_prompt}{context_info}{conversation}\n\nMe: {request.message}"
...
async def generate_study_prompt(
    ...
    prompts = {
        ...
        "clarify": f"Help me understand what concepts are being tested in this question without giving the answer: {current_question}" if current_question else f"Help me clarify complex concepts in {context or 'my current study material'}."
    }
