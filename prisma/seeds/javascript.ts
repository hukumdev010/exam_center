      ...
      questions: {
        create: [
          ...
          },
          {
            ...
            explanation: 'The "this" keyword refers to the object that is currently executing the code. Its value depends on how a function is called. Reference: MDN Web Docs - this',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'The Event Loop is a mechanism that handles asynchronous operations in JavaScript. It continuously checks the call stack and task queue, moving tasks from the queue to the stack when the stack is empty. This enables non-blocking execution. Reference: MDN Web Docs - Event Loop, JavaScript.info - Event Loop',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'undefined means a variable has been declared but not assigned a value, or a property doesn\'t exist. null is an intentional absence of value, explicitly set by the programmer. undefined == null is true, but undefined === null is false. Reference: MDN Web Docs - null vs undefined',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Promises represent the eventual completion or failure of an asynchronous operation. They have three states: pending, fulfilled (resolved), or rejected. Promises can be chained using .then(), .catch(), and .finally(). Reference: MDN Web Docs - Promise, JavaScript.info - Promises',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Arrow functions have lexical "this" binding (inherit from enclosing scope), cannot be used as constructors, don\'t have their own arguments object, and are always anonymous. Regular functions have dynamic "this" binding, can be constructors, have arguments object, and can be named. Reference: MDN Web Docs - Arrow Functions',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'JavaScript uses prototypal inheritance where objects can inherit properties and methods from other objects via the prototype chain. Every object has a __proto__ property that points to its prototype. This enables code reuse and object extension. Reference: MDN Web Docs - Inheritance and the prototype chain',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Destructuring is a syntax that allows extracting values from arrays or properties from objects into distinct variables. It provides a concise way to unpack values. Example: const [a, b] = array; const {x, y} = object. Reference: MDN Web Docs - Destructuring assignment',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Template literals are string literals allowing embedded expressions, multi-line strings, and string interpolation using backticks (`). They support expression interpolation with ${expression} syntax and tagged templates for advanced string processing. Reference: MDN Web Docs - Template literals',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'async/await is syntactic sugar over Promises that makes asynchronous code look and behave more like synchronous code. async functions always return a Promise, and await pauses execution until the Promise resolves. This improves readability and error handling. Reference: MDN Web Docs - async function, JavaScript.info - Async/await',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'map() transforms each element and returns a new array of same length. filter() returns a new array with elements passing a test condition. reduce() accumulates array elements into a single value using an accumulator function. All are pure functions that don\'t mutate the original array. Reference: MDN Web Docs - Array methods',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'ES6 modules allow code organization into separate files with explicit imports/exports. They have their own scope, are statically analyzable, and support both named exports (export const x) and default exports (export default). Modules are automatically in strict mode. Reference: MDN Web Docs - JavaScript modules',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'The Temporal Dead Zone is the time between entering a scope and the declaration being initialized for let/const variables. During TDZ, accessing the variable throws a ReferenceError. This prevents using variables before declaration, unlike var which gets hoisted with undefined. Reference: MDN Web Docs - let, JavaScript.info - Variable hoisting',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'WeakMap and WeakSet are collections that hold weak references to their keys/values. Keys in WeakMap must be objects, and entries are garbage collected when keys become unreachable. They\'re not enumerable and don\'t prevent memory leaks. Useful for private data and metadata. Reference: MDN Web Docs - WeakMap, WeakSet',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Currying is a functional programming technique that transforms a function with multiple parameters into a sequence of functions, each taking a single parameter. It enables partial application and function composition. Example: f(a,b,c) becomes f(a)(b)(c). Reference: JavaScript.info - Currying, Functional Programming concepts',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Synchronous code executes line by line, blocking further execution until current operation completes. Asynchronous code allows operations to run in background while other code continues executing, using callbacks, promises, or async/await. This prevents UI freezing and improves performance. Reference: MDN Web Docs - Asynchronous JavaScript',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Generators are functions that can be paused and resumed, yielding values one at a time. They use function* syntax and yield keyword. They return an iterator object with next() method. Useful for lazy evaluation, infinite sequences, and async iteration. Reference: MDN Web Docs - Generators',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Symbol is a primitive type that creates unique identifiers. Each Symbol() call returns a unique symbol, even with same description. Symbols are often used as object property keys to avoid naming collisions. Symbol.for() creates global symbols. Reference: MDN Web Docs - Symbol',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Shallow copy copies only the first level properties. Nested objects/arrays are still referenced. Deep copy creates completely independent copy of all levels. Methods: Object.assign() (shallow), JSON.parse/stringify (deep but limited), structuredClone() (modern deep copy). Reference: MDN Web Docs - Object.assign, structuredClone',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Proxies allow you to intercept and customize operations on objects (property access, assignment, enumeration, function calls). They use handlers (traps) to define custom behavior. Useful for validation, property access logging, virtual objects, and API wrappers. Reference: MDN Web Docs - Proxy',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Memoization is an optimization technique that stores function results based on input parameters. When the same inputs occur again, the cached result is returned instead of recalculating. Improves performance for expensive, pure functions with repeated calls. Reference: JavaScript optimization patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'forEach() executes a function for each array element but returns undefined. Used for side effects like logging or DOM manipulation. map() creates and returns a new array with transformed elements. Use forEach for side effects, map for transformations. Reference: MDN Web Docs - Array.forEach, Array.map',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'ES6 classes are syntactic sugar over prototypal inheritance. They provide cleaner syntax for constructor functions and prototype methods. Support inheritance with extends, super() for parent constructor, static methods, and private fields (#field). Still prototype-based under the hood. Reference: MDN Web Docs - Classes',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Debouncing delays function execution until after a quiet period (no more calls for X ms). Throttling limits function execution to once per time interval. Debouncing is good for search input, throttling for scroll/resize events. Both optimize performance by reducing function calls. Reference: JavaScript performance optimization patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Object.freeze() prevents all modifications (add, delete, modify). Object.seal() allows modification of existing properties but prevents add/delete. Object.preventExtensions() only prevents adding new properties. Each has corresponding check methods (isFrozen, isSealed, isExtensible). Reference: MDN Web Docs - Object methods',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Iterables are objects that implement Symbol.iterator method, returning an iterator. Iterators have next() method returning {value, done} objects. Arrays, strings, maps, sets are built-in iterables. for...of loops work with iterables. Custom iterables enable clean data traversal patterns. Reference: MDN Web Docs - Iteration protocols',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Rest parameter (...args) collects multiple elements into an array, used in function parameters. Spread operator (...) expands arrays/objects into individual elements, used in function calls, array/object literals. Same syntax, different contexts and purposes. Reference: MDN Web Docs - Rest parameters, Spread syntax',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Module bundlers (webpack, Vite, Rollup) combine multiple JavaScript modules into optimized bundles for browsers. They resolve dependencies, transform code (transpiling, minification), handle assets, and enable code splitting. Essential for modern web development workflow. Reference: Webpack docs, Modern JavaScript tooling',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Function declarations are hoisted completely and can be called before definition. Function expressions are not hoisted and create functions as values assigned to variables. Arrow functions are always expressions. Declarations create function-scoped names, expressions can be anonymous. Reference: MDN Web Docs - Functions',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Getters and setters are special methods that allow defining object properties that behave like normal properties but execute functions when accessed/modified. Use get/set keywords or Object.defineProperty(). Enable validation, computed properties, and encapsulation. Reference: MDN Web Docs - get, set',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Observer pattern defines one-to-many dependency between objects. When subject changes state, all observers are notified automatically. Common implementations include EventEmitter in Node.js, custom event systems, and reactive programming libraries. Promotes loose coupling. Reference: JavaScript Design Patterns',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'JSON (JavaScript Object Notation) is a text-based data interchange format. JavaScript provides JSON.parse() to convert JSON strings to objects and JSON.stringify() to convert objects to JSON strings. Supports strings, numbers, booleans, arrays, objects, and null. No functions, undefined, or symbols. Reference: MDN Web Docs - JSON',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Regular expressions (RegExp) are patterns used to match character combinations in strings. Created with /pattern/flags or new RegExp(). Common methods: test(), exec(), match(), replace(), search(). Flags include g (global), i (case-insensitive), m (multiline). Essential for string validation and parsing. Reference: MDN Web Docs - Regular Expressions',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'localStorage persists until explicitly cleared, has ~5-10MB limit, client-side only. sessionStorage lasts for session/tab, same size limit. Cookies are smaller (~4KB), sent with HTTP requests, have expiration dates, can be server or client-side. Each serves different storage needs. Reference: MDN Web Docs - Web Storage API',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Functional programming treats computation as evaluation of mathematical functions, avoiding state mutation and side effects. Key concepts: pure functions, immutability, higher-order functions, function composition, currying. JavaScript supports FP with map/filter/reduce, closures, and first-class functions. Reference: Functional Programming concepts',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Web APIs are browser-provided interfaces for interacting with browser features and services. Examples: DOM API, Fetch API, Geolocation API, Web Storage API, Canvas API, Web Workers. They extend JavaScript capabilities beyond the core language specification. Reference: MDN Web Docs - Web APIs',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Loose equality (==) performs type coercion before comparison, converting operands to same type. Strict equality (===) compares both value and type without coercion. Examples: "5" == 5 is true, "5" === 5 is false. Always prefer === for predictable comparisons. Reference: MDN Web Docs - Equality comparisons',
            points: 1,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Promise chaining allows sequential async operations using .then(). Each .then() returns a new promise. Errors propagate down the chain until caught by .catch(). .finally() runs regardless of resolution. async/await provides cleaner syntax for the same concepts. Reference: MDN Web Docs - Using Promises',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Event bubbling: events trigger from target element up to root. Event capturing: events trigger from root down to target. Event propagation has 3 phases: capturing, target, bubbling. stopPropagation() stops further propagation. addEventListener() third parameter controls capture phase. Reference: MDN Web Docs - Event propagation',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Module Pattern uses closures to create private scope and expose public API. Classic implementation uses IIFE (Immediately Invoked Function Expression) returning object with public methods. Provides encapsulation and namespace management. Modern ES6 modules replaced this pattern. Reference: JavaScript Design Patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Typed arrays provide a way to work with binary data in JavaScript. Types include Int8Array, Uint8Array, Float32Array, etc. They offer better performance for numerical computations and are used with WebGL, Canvas, File API. Based on ArrayBuffer for raw binary data. Reference: MDN Web Docs - Typed Arrays',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Synchronous iteration uses for...of with regular iterables, blocking until each value is available. Asynchronous iteration uses for await...of with async iterables, allowing await within iteration. Async iterables implement Symbol.asyncIterator. Useful for streams and async data sources. Reference: MDN Web Docs - for await...of',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'BigInt represents integers larger than Number.MAX_SAFE_INTEGER (2^53 - 1). Created with BigInt() function or n suffix (123n). Cannot mix with regular numbers in operations. Useful for cryptography, precise calculations, working with large datasets or IDs. Reference: MDN Web Docs - BigInt',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Singleton Pattern ensures a class has only one instance and provides global access point. Implementation can use closures, modules, or classes with static instance property. Common uses: database connections, logging, configuration objects. Can make testing difficult due to global state. Reference: JavaScript Design Patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Tail call optimization (TCO) is when the last operation in a function is a call to another function. The current stack frame can be replaced instead of adding new one, preventing stack overflow in recursive functions. ES6 spec includes TCO but browser support is limited. Reference: ECMAScript specification',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Decorators are a stage 3 proposal for extending classes and class members with additional functionality. They use @ syntax and are functions that modify classes, methods, or properties. Popular in frameworks like Angular. Similar to annotations in other languages. Reference: ECMAScript decorators proposal',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Tagged templates allow you to parse template literals with a function. The tag function receives an array of string pieces and values as arguments. Enables custom processing like escaping, internationalization, or DSLs. Example: styled`color: ${color};` in styled-components. Reference: MDN Web Docs - Tagged templates',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Revealing Module Pattern is a variation of Module Pattern where all methods are defined privately and selectively exposed in return statement. Provides cleaner syntax and makes it clear what\'s public vs private. Uses IIFE and returns object literal mapping public names to private functions. Reference: JavaScript Design Patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'ArrayBuffer represents raw binary data buffer. DataView provides a low-level interface for reading/writing multiple number types in ArrayBuffer at specified byte offsets. Useful for binary protocols, file formats, and WebAssembly interfacing. TypedArrays are higher-level views of ArrayBuffers. Reference: MDN Web Docs - ArrayBuffer, DataView',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Factory Pattern creates objects without specifying exact classes. A factory function returns new objects based on parameters. Provides abstraction over object creation, enabling polymorphism and reducing coupling. Common in JavaScript due to its flexible object creation mechanisms. Reference: JavaScript Design Patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Service Workers are scripts that run in background, separate from web pages, enabling features like push notifications, background sync, and offline functionality. They act as proxy between app and network, can intercept requests, cache resources. Essential for Progressive Web Apps (PWAs). Reference: MDN Web Docs - Service Worker API',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Imperative programming describes HOW to do something step-by-step (for loops, if statements). Declarative programming describes WHAT you want (map, filter, SQL). JavaScript supports both paradigms. Functional programming tends to be declarative, while procedural is imperative. Reference: Programming paradigms',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Web Workers run JavaScript in background threads, separate from main UI thread. They enable parallel processing without blocking user interface. Cannot directly access DOM but can communicate via message passing. Types include dedicated workers, shared workers, and service workers. Reference: MDN Web Docs - Web Workers API',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Command Pattern encapsulates requests as objects, allowing parameterization of clients with different requests, queuing operations, and supporting undo functionality. Commands have execute() and optional undo() methods. Useful for implementing macro recording, undo/redo systems, and queuing systems. Reference: JavaScript Design Patterns',
            points: 3,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Mixins are a way to achieve multiple inheritance by copying properties from one object to another. JavaScript doesn\'t have built-in multiple inheritance, so mixins provide a composition-based approach. Can be implemented with Object.assign() or custom mixing functions. Promotes code reuse. Reference: JavaScript composition patterns',
            points: 2,
            answers: {
              create: [
          ...
          },
          {
            ...
            explanation: 'Adapter Pattern allows incompatible interfaces to work together by wrapping existing interface with a new one. Acts as bridge between different APIs or data formats. Common when integrating third-party libraries or legacy code. Example: adapting different API response formats to unified interface. Reference: JavaScript Design Patterns',
            points: 2,
            answers: {
              create: [
